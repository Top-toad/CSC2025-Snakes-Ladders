 ...
 * @version 22/7/25
 */
public class ComSciAssessmentSnakesandLaddersV5
{
    ...
    /**
     * Constructor for objects of class ComSciAssessmentSnakesandLaddersV5
     */
    public ComSciAssessmentSnakesandLaddersV5()
    {
    ...
    void counterMovementA(int finalRoll){
        ...
        System.out.println ("***************"+currentAXPos);//debug
