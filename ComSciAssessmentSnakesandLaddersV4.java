 ...
 * @version 21/7/25
 */
public class ComSciAssessmentSnakesandLaddersV4
{
    ...
    private int BothPlayersShowing= 0;
    ...
    /**
     * Constructor for objects of class ComSciAssessmentSnakesandLaddersV4
     */
    public ComSciAssessmentSnakesandLaddersV4()
    {
    ...
    void counterMovementA(int finalRoll){
        ...
        gameBoard[currentAXPos][currentAYPos]= EMPTY;
    ...
    void counterMovementE(int finalRoll){
        ...
        gameBoard[currentEXPos][currentEYPos]= EMPTY;
